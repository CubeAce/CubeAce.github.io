...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._hood_popup.ggUpdateText=function() {
			var hs="<iframe src=\""+player.getVariableValue('VehicleHudURL')+"\" width=\"100%\" height=\"100%\" frameborder= \"0\" scrolling=\"no\"><\/iframe>";
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		els.innerHTML="<iframe src=\"interiorV1.html\" width=\"100%\" height=\"100%\" frameborder= \"0\" scrolling=\"no\"><\/iframe>";
		el.appendChild(els);
		...
		me._vehicle1interior.onclick=function (e) {
			...
			if (player.transitionsDisabled) {
				...
				me._vehicleintinfo.style[domTransition]='all 800ms ease-out 0ms';
			}
			if (flag) {
				me._vehicleintinfo.style.opacity='0';
				me._vehicleintinfo.style.visibility='hidden';
