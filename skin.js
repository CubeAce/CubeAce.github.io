...
// Filename: Toyota_HS_TemplateV3.ggsk
// Generated 2019-05-16T20:12:04
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._hood_popup.ggUpdateText=function() {
			var hs="<iframe src=\"assets2\/"+player.getVariableValue('VehicleHudURL')+"\" width=\"100%\" height=\"100%\" frameborder= \"0\" scrolling=\"no\"><\/iframe>";
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._vehiclel5hood.onclick=function (e) {
			player.setVariableValue('VehicleHudURL', "HoodLV5.html");
		...
		me._vehiclel4hood.onclick=function (e) {
			player.setVariableValue('VehicleHudURL', "HoodLV4.html");
		...
		me._vehiclel2hood.onclick=function (e) {
			player.setVariableValue('VehicleHudURL', "HoodLV2.html");
			player.setVariableValue('VehiclePopTitle', "HiLux Engine View");
			var flag=me._vehiclehudinfo.ggOpacitiyActive;
			if (player.transitionsDisabled) {
				me._vehiclehudinfo.style[domTransition]='none';
		...
		me._vehiclel1hood.onclick=function (e) {
			player.setVariableValue('VehicleHudURL', "HoodLV1.html");
		...
		me._vehicler5hood.onclick=function (e) {
			player.setVariableValue('VehicleHudURL', "HoodRV5.html");
		...
		me._vehicler3hood.onclick=function (e) {
			player.setVariableValue('VehicleHudURL', "HoodRV3.html");
		...
		me._vehicler2hood.onclick=function (e) {
			player.setVariableValue('VehicleHudURL', "HoodRV2.html");
		...
		me._vehicler1hood.onclick=function (e) {
			player.setVariableValue('VehicleHudURL', "HoodRV1.html");
			player.setVariableValue('VehiclePopTitle', "Vios Engine View");
			var flag=me._vehiclehudinfo.ggOpacitiyActive;
			if (player.transitionsDisabled) {
				me._vehiclehudinfo.style[domTransition]='none';
		...
		me._vehicle2hood.onclick=function (e) {
			player.setVariableValue('VehicleHudURL', "HoodV2.html");
		...
		me._vehicle1hood.onclick=function (e) {
			player.setVariableValue('VehicleHudURL', "HoodV1.html");
			player.setVariableValue('VehiclePopTitle', "Grandia Engine view");
			var flag=me._vehiclehudinfo.ggOpacitiyActive;
			if (player.transitionsDisabled) {
				me._vehiclehudinfo.style[domTransition]='none';
		...
		me._interior_popup.ggUpdateText=function() {
			var hs="<iframe src=\"assets1\/"+player.getVariableValue('VehicleIntURL')+"\" width=\"100%\" height=\"100%\" frameborder= \"0\" scrolling=\"no\"><\/iframe>";
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._interior_popup.ggUpdateText();
		player.addListener('timer', function() {
			me._interior_popup.ggUpdateText();
		});
		el.appendChild(els);
		...
		me._vehiclel5interior.onclick=function (e) {
			player.setVariableValue('VehicleIntURL', "InteriorLV5.html");
		...
		me._vehiclel4interior.onclick=function (e) {
			player.setVariableValue('VehicleIntURL', "InteriorLV4.html");
		...
		me._vehiclel1interior.onclick=function (e) {
			player.setVariableValue('VehicleIntURL', "InteriorLV1.html");
		...
		me._vehicler5interior.onclick=function (e) {
			player.setVariableValue('VehicleIntURL', "InteriorRV5.html");
		...
		me._vehicler3interior.onclick=function (e) {
			player.setVariableValue('VehicleIntURL', "InteriorRV3.html");
		...
		me._vehicler2interior.onclick=function (e) {
			player.setVariableValue('VehicleIntURL', "InteriorRV2.html");
		...
		me._vehicler1interior.onclick=function (e) {
			player.setVariableValue('VehicleIntURL', "InteriorRV1.html");
			player.setVariableValue('VehiclePopTitle', "Vios Interior View");
			var flag=me._vehicleintinfo.ggOpacitiyActive;
			if (player.transitionsDisabled) {
				me._vehicleintinfo.style[domTransition]='none';
		...
		me._vehicle2interior.onclick=function (e) {
			player.setVariableValue('VehicleIntURL', "InteriorV2.html");
		...
		me._vehicle1interior.onclick=function (e) {
			player.setVariableValue('VehicleIntURL', "interiorV1.html");
			player.setVariableValue('VehiclePopTitle', "Grandia Interior View");
			var flag=me._vehicleintinfo.ggOpacitiyActive;
			if (player.transitionsDisabled) {
				me._vehicleintinfo.style[domTransition]='none';
...
this.__div.style.top = vs.height / 2 + "px";
	...
	player.addListener('changenode', function(args) { me._tt_togglemap.logicBlock_text();me._button_close_map.logicBlock_visible();me._screentint_info.logicBlock_visible();me._tt_thumbnail_open.logicBlock_text();me._thumbnail_menu.logicBlock_alpha(); });
